...
from project.forms import UpdateUser, ReservationForm, LoginForm, RegisterForm, AddMenuForm
...
class UpdateReservation(LoginRequiredMixin, UpdateView):
    ...
    def form_valid(self, form):
        send_mail('Reservation status: '+form.cleaned_data['status'],'Hello '+form.cleaned_data['first_name']+',\nThank you for booking with us.\n'+form.cleaned_data['comment']+'\nBest Regards,\nTeam Ravintola Mangal','sumdah@utu.fi',[form.cleaned_data['email']])
        form.save()
...
class AddMenu(LoginRequiredMixin, CreateView):
    """Admin user add new reservation."""
    template_name = "super/add_menu_form.html"
